...
SETUP_ROS_STRING="export ROS_MASTER_URI=${MASTER_URI}; source ~/sim_ws/HKUST/fast_planner_ws/devel/setup.bash"
...
tmux send-keys -t $SESSION_NAME "$SETUP_ROS_STRING; sleep 4; roslaunch plan_manage kino_replan.launch" Enter
